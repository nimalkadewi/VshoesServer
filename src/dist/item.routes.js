...
exports.itemRouter.get("/", function (_req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2, , 3]);
          return [4 /*yield*/, database_1.collections.items.find({}).toArray()];
        case 1:
          item = _a.sent();
...
exports.itemRouter.get("/:id", function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, query, item, error_2;
    var _a, _b;
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          _c.trys.push([0, 2, , 3]);
          id =
            (_a = req === null || req === void 0 ? void 0 : req.params) ===
              null || _a === void 0
              ? void 0
              : _a.id;
          query = { _id: new mongodb.ObjectId(id) };
          return [4 /*yield*/, database_1.collections.items.findOne(query)];
        case 1:
          item = _c.sent();
          if (item) {
            res.status(200).send(item);
...
exports.itemRouter.post("/", function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2, , 3]);
          item = req.body;
          return [4 /*yield*/, database_1.collections.items.insertOne(item)];
        case 1:
          result = _a.sent();
          if (result.acknowledged) {
            res
              .status(201)
              .send("Added a new Item: ID " + result.insertedId + ".");
          } else {
...
exports.itemRouter.put("/:id", function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, item, query, result, error_4;
    var _a;
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            database_1.collections.items.updateOne(query, { $set: item }),
          ];
        case 1:
          result = _b.sent();
...
exports.itemRouter["delete"]("/:id", function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
        ...
        case 0:
          ...
          id =
            (_a = req === null || req === void 0 ? void 0 : req.params) ===
              ...
              : _a.id;
          query = { _id: new mongodb.ObjectId(id) };
          return [4 /*yield*/, database_1.collections.items.deleteOne(query)];
        case 1:
          result = _b.sent();
